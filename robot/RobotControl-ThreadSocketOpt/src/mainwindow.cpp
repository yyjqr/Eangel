...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::MainWindow), b_grabPic(false),
      m_saveIndex(0), m_getImageCount(0), m_picToshow({nullptr, 1280, 720, 0}) {
  ui->setupUi(this);
  ...
  // 增加失去服务器连接的相关操作
  connect(showThread, SIGNAL(SIGNAL_camSocketDisconnect()), this,
...
void MainWindow::getPicToShow(camInfo &frameToShow) {
  ...
  m_getImageCount++;
  //     qDebug() << "fun: "
  //     <<__func__<<"frameToShow.imageBuf:"<<frameToShow.imageBuf;
  ...
  if (frameToShow.imageBuf != nullptr) {
    ...
    if (m_getImageCount % 3 == 0) {
      ...
      ShowImage(frameToShow.imageBuf, imageWidth, imageHeight,
