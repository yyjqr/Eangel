...
enum AVPixelFormat {
  ...
  AV_PIX_FMT_VAAPI_MOCO, ///< HW acceleration through VA API at motion
                         ///< compensation entry-point, Picture.data[3] contains
                         ///< a vaapi_render_state struct which contains
                         ///< macroblocks as well as various fields extracted
                         ///< from headers
  AV_PIX_FMT_VAAPI_IDCT, ///< HW acceleration through VA API at IDCT
                         ///< entry-point, Picture.data[3] contains a
                         ///< vaapi_render_state struct which contains fields
