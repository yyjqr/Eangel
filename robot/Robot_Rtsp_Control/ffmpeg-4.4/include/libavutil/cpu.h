...
#define AV_CPU_FLAG_AVX512                                                     \
  0x100000 ///< AVX-512 functions: requires OS support even if YMM/ZMM registers
           ///< aren't used
 ...
 * Please use av_force_cpu_flags() and av_get_cpu_flags() instead which are more
 * flexible
 */
 ...
 *
 * The returned flags contain the specified flags as well as related unspecified
 * flags.
 *
