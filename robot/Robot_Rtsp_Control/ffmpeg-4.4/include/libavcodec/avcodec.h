...
attribute_deprecated const AVCodecDescriptor *
...
attribute_deprecated unsigned
av_codec_get_codec_properties(const AVCodecContext *avctx);
...
attribute_deprecated uint16_t *
av_codec_get_chroma_intra_matrix(const AVCodecContext *avctx);
attribute_deprecated void
av_codec_set_chroma_intra_matrix(AVCodecContext *avctx, uint16_t *val);
#endif
...
attribute_deprecated void
avcodec_get_chroma_sub_sample(enum AVPixelFormat pix_fmt, int *h_shift,
                              int *v_shift);
#endif
 ...
 */
attribute_deprecated int
avcodec_get_pix_fmt_loss(enum AVPixelFormat dst_pix_fmt,
                         enum AVPixelFormat src_pix_fmt, int has_alpha);
/**
 * @deprecated see av_find_best_pix_fmt_of_2()
 */
attribute_deprecated enum AVPixelFormat avcodec_find_best_pix_fmt_of_2(
 ...
 */
attribute_deprecated AVBitStreamFilterContext *
 ...
 * (using AVBSFContext).
 */
attribute_deprecated const AVBitStreamFilter *
