...
void VideoPlayer::run() {
  ...
  // char
  // url[]="rtsp://admin:Admin123@192.168.1.246:554/h264/ch1/sub/av_stream";
  ...
  for (int k = 0; k < pFormatCtx->nb_streams; k++) {
    if (pFormatCtx->streams[k]->codecpar->codec_type == AVMEDIA_TYPE_VIDEO) {
      videoStream = k;
    } // codec-->codecpar  revise Jack 04.22
  }
