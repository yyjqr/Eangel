...
int main(int argc, char **argv) {
    ...
    pCapture.open(0); //从摄像头读入视频 0表示从摄像头读入
    ...
    pCapture.set(CV_CAP_PROP_FRAME_WIDTH, 1280);
    pCapture.set(CV_CAP_PROP_FRAME_HEIGHT, 1280);
    ...
    //cvReleaseCapture(&pCapture);  // free memory  --->AUTO FREE
