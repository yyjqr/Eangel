...
HelloWorld::HelloWorld(HelloWorld &&x) noexcept {
  m_index = x.m_index;
  m_velocity = x.m_velocity;
...
HelloWorld &HelloWorld::operator=(HelloWorld &&x) noexcept {
...
bool HelloWorld::operator==(const HelloWorld &x) const {
  return (m_index == x.m_index && m_velocity == x.m_velocity &&
          m_message == x.m_message);
}

bool HelloWorld::operator!=(const HelloWorld &x) const { return !(*this == x); }
