...
HelloWorldPubSubType::HelloWorldPubSubType() {
  ...
  uint32_t keyLength = HelloWorld_max_key_cdr_typesize > 16
...
bool HelloWorldPubSubType::deserialize(SerializedPayload_t *payload,
                                       void *data) {
  try {
...
std::function<uint32_t()> HelloWorldPubSubType::getSerializedSizeProvider(
  ...
  return [data, data_representation]() -> uint32_t {
    ...
    return static_cast<uint32_t>(
               type::getCdrSerializedSize(*static_cast<HelloWorld *>(data))) +
           4u /*encapsulation*/;
#else
    try {
...
bool HelloWorldPubSubType::getKey(void *data, InstanceHandle_t *handle,
  ...
  // Object that manages the raw buffer.
  eprosima::fastcdr::FastBuffer fastbuffer(
      reinterpret_cast<char *>(m_keyBuffer), HelloWorld_max_key_cdr_typesize);
