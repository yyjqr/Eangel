...
/*!
 * @brief This class represents the structure HelloWorld defined by the user in
 * the IDL file.
 * @ingroup HelloWorld
 */
class HelloWorld {
public:
   ...
   * @param x Reference to the object HelloWorld that will be copied.
   */
  eProsima_user_DllExport HelloWorld(HelloWorld &&x) noexcept;
   ...
   * @param x Reference to the object HelloWorld that will be copied.
   */
  eProsima_user_DllExport HelloWorld &operator=(HelloWorld &&x) noexcept;
