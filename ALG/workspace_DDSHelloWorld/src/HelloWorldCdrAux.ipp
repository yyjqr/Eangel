...
calculate_serialized_size(eprosima::fastcdr::CdrSizeCalculator &calculator,
                          const HelloWorld &data, size_t &current_alignment) {
  ...
  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(1), data.velocity(), current_alignment);

  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(2), data.message(), current_alignment);
