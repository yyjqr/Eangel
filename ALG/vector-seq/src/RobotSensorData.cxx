...
RobotSensorData::RobotSensorData(const RobotSensorData &x) {
  m_index = x.m_index;
  m_id = x.m_id;
...
RobotSensorData::RobotSensorData(RobotSensorData &&x) noexcept {
  m_index = x.m_index;
  m_id = x.m_id;
  m_velocity = x.m_velocity;
  m_positionX = x.m_positionX;
...
RobotSensorData &RobotSensorData::operator=(const RobotSensorData &x) {
...
RobotSensorData &RobotSensorData::operator=(RobotSensorData &&x) noexcept {
...
bool RobotSensorData::operator==(const RobotSensorData &x) const {
  return (m_index == x.m_index && m_id == x.m_id &&
          m_velocity == x.m_velocity && m_positionX == x.m_positionX &&
          m_positionY == x.m_positionY && m_message == x.m_message);
}
 ...
 */
void RobotSensorData::message(std::string &&_message) {
 ...
 */
const std::string &RobotSensorData::message() const { return m_message; }

/*!
 * @brief This function returns a reference to member message
 * @return Reference to member message
 */
std::string &RobotSensorData::message() { return m_message; }

RobotFrameInfoData::RobotFrameInfoData() {}

RobotFrameInfoData::~RobotFrameInfoData() {}

RobotFrameInfoData::RobotFrameInfoData(const RobotFrameInfoData &x) {
  m_m_vec_Robot_Info = x.m_m_vec_Robot_Info;
}

RobotFrameInfoData::RobotFrameInfoData(RobotFrameInfoData &&x) noexcept {
  m_m_vec_Robot_Info = std::move(x.m_m_vec_Robot_Info);
}

RobotFrameInfoData &RobotFrameInfoData::operator=(const RobotFrameInfoData &x) {
...
RobotFrameInfoData &
RobotFrameInfoData::operator=(RobotFrameInfoData &&x) noexcept {

  m_m_vec_Robot_Info = std::move(x.m_m_vec_Robot_Info);
  return *this;
}

bool RobotFrameInfoData::operator==(const RobotFrameInfoData &x) const {
 ...
 */
const std::vector<RobotSensorData> &
RobotFrameInfoData::m_vec_Robot_Info() const {
