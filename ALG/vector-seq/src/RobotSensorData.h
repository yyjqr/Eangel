...
/*!
 * @brief This class represents the structure RobotSensorData defined by the
...
public:
   ...
   */
  eProsima_user_DllExport RobotSensorData(const RobotSensorData &x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object RobotSensorData that will be copied.
   */
  eProsima_user_DllExport RobotSensorData(RobotSensorData &&x) noexcept;

  /*!
   * @brief Copy assignment.
   * @param x Reference to the object RobotSensorData that will be copied.
   */
  eProsima_user_DllExport RobotSensorData &operator=(const RobotSensorData &x);
   ...
   */
  eProsima_user_DllExport RobotSensorData &
  operator=(RobotSensorData &&x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x RobotSensorData object to compare.
   */
  eProsima_user_DllExport bool operator==(const RobotSensorData &x) const;
   ...
   */
  eProsima_user_DllExport void positionX(double _positionX);
   ...
   */
  eProsima_user_DllExport void positionY(double _positionY);
...
/*!
 * @brief This class represents the structure RobotFrameInfoData defined by the
 * user in the IDL file.
 * @ingroup RobotSensorData
 */
...
public:
   ...
   */
  eProsima_user_DllExport RobotFrameInfoData(const RobotFrameInfoData &x);

  /*!
   * @brief Move constructor.
   * @param x Reference to the object RobotFrameInfoData that will be copied.
   */
  eProsima_user_DllExport RobotFrameInfoData(RobotFrameInfoData &&x) noexcept;
   ...
   */
  eProsima_user_DllExport RobotFrameInfoData &
  operator=(const RobotFrameInfoData &x);
   ...
   */
  eProsima_user_DllExport RobotFrameInfoData &
  operator=(RobotFrameInfoData &&x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x RobotFrameInfoData object to compare.
   */
  eProsima_user_DllExport bool operator==(const RobotFrameInfoData &x) const;
  ...
  m_vec_Robot_Info(const std::vector<RobotSensorData> &_m_vec_Robot_Info);
   ...
   */
  eProsima_user_DllExport void
  m_vec_Robot_Info(std::vector<RobotSensorData> &&_m_vec_Robot_Info);
   ...
   */
  eProsima_user_DllExport const std::vector<RobotSensorData> &
  m_vec_Robot_Info() const;
