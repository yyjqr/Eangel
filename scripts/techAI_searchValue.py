#拼接字符串并换行
## -*- coding: UTF-8 -*-
#@author: JACK YANG 201902-->10 --->202006-->202101
...
#receiver=my_sender
#_pwd = "tfqlcytviyqdbc"  #202010---202102   #需在qq邮箱开启SMTP服务并获取授权码
_pwd ="rulnucXnyqcpbbbf"  #202010---202110   #需在qq邮箱开启SMTP服务并获取授权码
