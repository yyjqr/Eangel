...
/*!
 *  @brief This API reads the data of axes to be stored in the FIFO in the gyro
 * sensor.
 *
 *  @param[out]  fifo_data_select : Pointer variable used to get the selected
 * data axes for FIFO data storage. value                 |  fifo_data_select
 *  --------------------------------|-------------------------
 ...
 * sensor.
 *
 *  @param[in]  fifo_data_select : Variable used to select data of axis to be
 * stored in fifo value                 |  Data of axis stored in FIFO
 *  --------------------------------|-------------------------
 *   BMI088_GYRO_ALL_INT_DATA       |  X,Y,Z plus INT_status 0 and 1
 *   BMI088_GYRO_X_DATA             |  X only
 *   BMI088_GYRO_Y_DATA             |  Y only
