...
/*! \mainpage C library for Broadcom BCM 2835 as used in Raspberry Pi
  ...
  and discussions on this topic. Do not contact the author directly, unless it
  is to discuss commercial licensing. Before asking a question or reporting a
  bug, please read http://www.catb.org/esr/faqs/smart-questions.html
  ...
  peripherals are set up to map onto the peripheral bus address range starting
  at 0x7E000000. Thus a peripheral advertised in the manual at bus address
  ...
  the underlying BCM 2835 chip pin numbering.
  ...
  number and _not_ the RPi pin number. There are symbolic definitions for each
  of the available pins that you should use for convenience. See \ref
  RPiGPIOPin.
  ...
  interface pins from their default GPIO behaviour in order to support SPI.
  While SPI is in use, you will not be able to control the state of the SPI pins
  ...
  pin  PWM Channel    ALT FUN 12                    0            0 13 1 0 18
  1-12       0            5 19                    1            5 40 0 0 41 1 0
  45                    1            0
  52                    0            1
  53                    1            1
  \endcode
  ...
  overall DATA pulses per RANGE pulses. In Mark-Space mode, the hardware sets
  the output HIGH for DATA clock pulses wide, followed by LOW for RANGE-DATA
  clock pulses.

  The PWM clock can be set to control the PWM pulse widths. The PWM clock is
  derived from a 19.2MHz clock. You can set any divider, but some common ones
  are provided by the BCM2835_PWM_CLOCK_DIVIDER_* values of \ref
  ...
  utility for Raspberry Pi, based on the bcm2835 library. The utility, spincl,
  is licensed under Open Source GNU GPLv3 by iP Solutions
  ...
  Contributed by Arjan van Vught. \version 1.19 Removed inlines added by
  previous patch since they don't seem to work everywhere. Reported by olly.
  ...
  is now automatically included. Added suport for PWM mode with bcm2835_pwm_*
  functions.
  ...
  hardware. Testers please confirm correct operation on RPi2.<br> Unneccessary
  ...
  on RPI2.<br> Improvements to detection of availablity of DMB instruction based
  ...
  \version 1.46 2015-09-18
           Added symbolic definitions for remaining pins on 40 pin GPIO header
  on RPi 2. <br>
...
/* RPi 2 is ARM v7, and has DMB instruction for memory barriers.
   ...
   assembler instruction even on conmpatible processors. This test is so any
...
/*! On RPi2 with BCM2836, and all recent OSs, the base of the peripherals is
...
typedef enum {
  BCM2835_SPI_CLOCK_DIVIDER_65536 =
      0, /*!< 65536 = 262.144us = 3.814697260kHz */
  BCM2835_SPI_CLOCK_DIVIDER_32768 =
      32768, /*!< 32768 = 131.072us = 7.629394531kHz */
  BCM2835_SPI_CLOCK_DIVIDER_16384 =
      16384, /*!< 16384 = 65.536us = 15.25878906kHz */
  BCM2835_SPI_CLOCK_DIVIDER_8192 =
      8192, /*!< 8192 = 32.768us = 30/51757813kHz */
  BCM2835_SPI_CLOCK_DIVIDER_4096 =
      4096, /*!< 4096 = 16.384us = 61.03515625kHz */
  ...
  BCM2835_SPI_CLOCK_DIVIDER_1 =
      1 /*!< 1 = 262.144us = 3.814697260kHz, same as 0/65536 */
...
/*! Sets the Pull-up/down register for the given pin. This is
  ...
  BCM2835_GPIO_PUD_* from bcm2835PUDControl \sa bcm2835_gpio_set_pud()
*/
...
/*! Transfers any number of bytes to the currently selected SPI slave.
  ...
  send. \param[in] len Number of bytes in the tbuf buffer, and the number of
  bytes to send
*/
