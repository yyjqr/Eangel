...
#@author: JACK YANG 201902-->10-->202008->202011 ->202104 yyjqr789@sina.com
#!/usr/bin/python3
import smtplib
...
#receiver=my_sender
_pwd = "XXfuxycoehyobbji"  #需在qq邮箱开启SMTP服务并获取授权码
...
class GrabNewsProduct():
    ...
    def getNews(self):
       ...
       # r2.encoding = 'utf-8'
        print ("requests.get(url).encoding ",requests.get(url).encoding)
