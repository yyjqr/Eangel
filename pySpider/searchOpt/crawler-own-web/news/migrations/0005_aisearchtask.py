    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_url', models.CharField(blank=True, default='', max_length=500, verbose_name='目标URL')),
                ('category', models.CharField(
                    choices=[('all', '全部'), ('tech', '科技'), ('economy', '经济'),
                             ('product', '产品'), ('military', '军事'), ('design', '设计'), ('science', '科学')],
                    default='all', max_length=20, verbose_name='分类')),
                ('status', models.CharField(
                    choices=[('pending', '等待中'), ('running', '抓取中'), ('done', '完成'), ('error', '失败')],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status', 'created_at'], name='ai_search_tasks_status_idx'),
        ),
    ]
