    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_type', models.CharField(choices=[('daily', '每日'), ('weekly', '每周'), ('monthly', '每月')], default='weekly', max_length=20, verbose_name='统计周期')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['period_type', 'period_start'], name='hot_product_period__01cc04_idx'), models.Index(fields=['category', 'period_start'], name='hot_product_categor_3fefa9_idx')],
            },
        ),
    ]
