...
class NewsScraper:
    ...
    def calculate_weight(self, title):
        ...
        if MILITARY_SIGNAL_KEYWORDS:
            mil_score = self.compute_rank_from_map(title, MILITARY_SIGNAL_KEYWORDS, fuzzy=False)
    ...
    def filter_and_store(self, keywords='科技'):
        ...
        for article_tuple in self.articles:
            ...
            if weight > kRankLevelValue:
                ...
                if ENRICH_CONTENT_ON_WRITE and needs_content_enrichment(content) and url:
