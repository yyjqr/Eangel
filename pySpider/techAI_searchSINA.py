...
#@author: JACK YANG 201902-->10 --->202006 yyjqr789@sina.com
#!/usr/bin/python3.5
import smtplib
...
my_sender='yyjqr789@sina.com' #发件人邮箱账号，为了后面易于维护，所以写成了变量
receiver='yyjqr789@sina.com' #收件人邮箱账号，为了后面易于维护，所以写成了变量
#receiver=my_sender

_pwd = "xxx"  #0603   #需在新浪邮箱开启SMTP服务并获取授权码
...
def mail():
  ...
  try:
    ...
    smtp.login(my_sender,_pwd)
    #发送邮件
#    for i in receiver:
 #       smtp.sendmail(my_sender,i,msg.as_string())
    smtp.sendmail(my_sender,[receiver,],msg.as_string())
    smtp.quit()
#原文链接：https://blog.csdn.net/Unstoppable365/java/article/details/103888970
